...
public class HMapII implements MapII, Cloneable, Serializable {
  ...
  /**
   * Constructs a new <tt>HMapII</tt> with the same mappings as the specified <tt>MapII</tt>. The
   * <tt>HMapII</tt> is created with default load factor (0.75) and an initial capacity sufficient
   * to hold the mappings in the specified <tt>MapII</tt>.
   * 
