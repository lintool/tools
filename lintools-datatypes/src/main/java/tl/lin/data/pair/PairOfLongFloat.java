...
/**
 * WritableComparable representing a pair consisting of a long and a float. The elements in the pair
 * are referred to as the left and right elements. The natural sort order is: first by the left
