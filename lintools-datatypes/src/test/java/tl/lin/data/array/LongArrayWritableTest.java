...
public class LongArrayWritableTest {
  ...
  public void testBasic1() throws IOException {
    LongArrayWritable array1 = new LongArrayWritable(new long[] { 1, 3, 53, 97, 286 });
    ...
    LongArrayWritable array2 = new LongArrayWritable(new long[] { 1, 3, 53, 97, 286 }, 3);
    assertEquals(1, array2.get(0));
    assertEquals(3, array2.get(1));
    assertEquals(53, array2.get(2));
    assertEquals(3, array2.size());

    LongArrayWritable array3 = new LongArrayWritable(new long[] {});
  ...
  public void testBasic2() throws IOException {
    ...
    long[] list1 = new long[] { 1, 3, 53, 97, 286 };
    ...
    long[] list2 = new long[] { 9, -1, 6, 22, 76 };
  ...
  public void testSerialize1() throws IOException {
    LongArrayWritable array = new LongArrayWritable(new long[] { 1, 3, 53, 97, 286 });
  ...
  public void testSerialize2() throws IOException {
    LongArrayWritable array = new LongArrayWritable(new long[] { 1, 3, 53, 97, 286 }, 4);
  ...
  public void testSerialize3() throws IOException {
    LongArrayWritable array = new LongArrayWritable(new long[] { 1, 2, 3, 4, 5 });
  ...
  public void testClone2() throws IOException {
    LongArrayWritable array = new LongArrayWritable(new long[] { 1, 3, 53, 97, 286 }, 2);
    assertEquals(1, array.get(0));
    assertEquals(3, array.get(1));
