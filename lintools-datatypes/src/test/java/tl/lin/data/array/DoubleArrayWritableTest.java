...
public class DoubleArrayWritableTest {
  ...
  public void testBasic1() throws IOException {
    DoubleArrayWritable array1 = new DoubleArrayWritable(new double[] { 1, 3, 53, 97, 286 });
    ...
    DoubleArrayWritable array2 = new DoubleArrayWritable(new double[] { 1, 3, 53, 97, 286 }, 3);
    ...
    DoubleArrayWritable array3 = new DoubleArrayWritable(new double[] {});
  ...
  public void testBasic2() throws IOException {
    ...
    double[] list1 = new double[] { 1, 3, 53, 97, 286 };
    ...
    double[] list2 = new double[] { 9, -1, 6, 22, 76 };
  ...
  public void testSerialize1() throws IOException {
    DoubleArrayWritable array = new DoubleArrayWritable(new double[] { 1, 3, 53, 97, 286 });
  ...
  public void testSerialize2() throws IOException {
    DoubleArrayWritable array = new DoubleArrayWritable(new double[] { 1, 3, 53, 97, 286 }, 4);
  ...
  public void testSerialize3() throws IOException {
    DoubleArrayWritable array = new DoubleArrayWritable(new double[] { 1, 2, 3, 4, 5 });
  ...
  public void testClone2() throws IOException {
    DoubleArrayWritable array = new DoubleArrayWritable(new double[] { 1, 3, 53, 97, 286 }, 2);
    assertEquals(1, array.get(0), 10e-6);
    assertEquals(3, array.get(1), 10e-6);
